...
const Skills = () => {
  return (
    <div className="w-full bg-secondary p-10  sm:pt-32 bg-cover  bg-no-repeat">
      <h1 className="text-4xl font-bold text-text font2 text-center">
        My Skills
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 mt-10">
        <div className="col-span-2 flex flex-wrap items-center  justify-center ">
          ...
          <div
            className="flex m-10 w-20 h-10 justify-center items-center flex-col
 ...
 text-text cursor-pointer transition-all hover:text-purple-300"
          ...
          <div
            className="flex m-10 w-20 h-10 justify-center items-center flex-col
 text-text cursor-pointer transition-all hover:text-pink-300"
          >
            <FontAwesomeIcon className="text-4xl" icon={faMicrosoft} />
            <h1 className="text-md font-bold text-center  mb-2">PowerApps</h1>
          </div>
        </div>
      </div>
    </div>
