...
<div className="flex flex-wrap">
   ...
   <div className="flex m-5">
     <div className="relative bg-special w-1 h-90 mr-5"></div>
        ...
        <img width="400" height="230" className="overflow-hidden h-[230px]" src="https://studyway-resources.s3.amazonaws.com/profilePictures/1668849573581.jpg" />
